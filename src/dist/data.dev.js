...
var data = {
  courses: [{
    ...
    description: "Learn the basics of the NumPy library in this tutorial for beginners",
    ...
    description: "In this video we walk through many of the fundamental concepts to use the Python Pandas Data Science Library",
    ...
    description: "In this Python Programming video, we will be learning how to get started with Matplotlib",
    ...
    description: "In this Python Programming video, we will be learning how to get started with Machine Learning",
    ...
    description: "Learn everything you need to know about OpenCV in this full course for beginners.",
    ...
    description: "This video will provide you with a comprehensive and detailed knowledge of Natural Language Processing, popularly known as NLP",
